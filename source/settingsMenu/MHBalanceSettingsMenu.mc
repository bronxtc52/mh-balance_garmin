...
class MHBalanceSettingsMenu extends WatchUi.Menu2 {
  function initialize() {
...
class MHBalanceSettingsDelegate extends WatchUi.Menu2InputDelegate {
  function initialize() {
...
function getThemeString(themeId as Number) {
  var _theme = [Rez.Strings.ThemeBalance, Rez.Strings.ThemeEarth, Rez.Strings.ThemeMars, Rez.Strings.ThemeBelt];
